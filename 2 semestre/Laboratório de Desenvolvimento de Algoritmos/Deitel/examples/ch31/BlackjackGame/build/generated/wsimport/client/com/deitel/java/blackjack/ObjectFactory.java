 ...
 * generated in the com.deitel.java.blackjack package. 
...
public class ObjectFactory {
    ...
    private final static QName _DealCard_QNAME = new QName("http://blackjack.java.deitel.com/", "dealCard");
    private final static QName _GetHandValueResponse_QNAME = new QName("http://blackjack.java.deitel.com/", "getHandValueResponse");
    private final static QName _Shuffle_QNAME = new QName("http://blackjack.java.deitel.com/", "shuffle");
    private final static QName _GetHandValue_QNAME = new QName("http://blackjack.java.deitel.com/", "getHandValue");
    private final static QName _DealCardResponse_QNAME = new QName("http://blackjack.java.deitel.com/", "dealCardResponse");
    private final static QName _ShuffleResponse_QNAME = new QName("http://blackjack.java.deitel.com/", "shuffleResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.deitel.java.blackjack
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.java.deitel.com/", name = "dealCard")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.java.deitel.com/", name = "getHandValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.java.deitel.com/", name = "shuffle")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.java.deitel.com/", name = "getHandValue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.java.deitel.com/", name = "dealCardResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://blackjack.java.deitel.com/", name = "shuffleResponse")
