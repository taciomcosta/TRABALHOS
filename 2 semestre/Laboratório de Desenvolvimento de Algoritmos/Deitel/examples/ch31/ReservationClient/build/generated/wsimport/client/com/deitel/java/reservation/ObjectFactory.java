 ...
 * generated in the com.deitel.java.reservation package. 
...
public class ObjectFactory {
    ...
    private final static QName _Reserve_QNAME = new QName("http://reservation.java.deitel.com/", "reserve");
    private final static QName _ReserveResponse_QNAME = new QName("http://reservation.java.deitel.com/", "reserveResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.deitel.java.reservation
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://reservation.java.deitel.com/", name = "reserve")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://reservation.java.deitel.com/", name = "reserveResponse")
