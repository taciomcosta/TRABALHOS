   ...
   <f:view>
      <webuijsf:page id="page1">
         <webuijsf:html id="html1">
            <webuijsf:head id="head1" webuiJsfx="true">
               <webuijsf:link id="link1" url="/resources/stylesheet.css"/>
            </webuijsf:head>
            <webuijsf:body id="body1" style="-rave-layout: grid">
               <webuijsf:form id="form1" virtualFormsConfig=
                  "addForm | firstNameTextField lastNameTextField
                  streetTextField cityTextField stateTextField
                  zipTextField | submitButton ,
                  SearchForm | lastNameSearchTextField searchTextArea |
                  searchButton">
                  ...
                  <webuijsf:label for="lastNameSearchTextField"
                     id="lastNameSearchLabel"
                     style="left: 24px; top: 552px; position: absolute"
                     text="Last name:"/>
                  <webuijsf:textField autoComplete="true"
                     autoCompleteExpression="#{SessionBean1.getOptions}"
                     binding="#{AddressBook.lastNameSearchTextField}"
                     id="lastNameSearchTextField" required="true"
                     style="left: 120px; top: 552px; position: absolute"/>
                  <webuijsf:button
                     actionExpression="#{AddressBook.searchButton_action}"
                     id="searchButton" style="left: 263px; top: 552px;
                        position: absolute; width: 38px" text="Find"/>
                  <webuijsf:textArea
                     binding="#{AddressBook.searchTextArea}" columns="50"
                     id="searchTextArea" rows="4" style="left: 336px;
                        top: 552px; position: absolute; z-index: 500"/>
               </webuijsf:form>
            </webuijsf:body>
         </webuijsf:html>
      </webuijsf:page>
