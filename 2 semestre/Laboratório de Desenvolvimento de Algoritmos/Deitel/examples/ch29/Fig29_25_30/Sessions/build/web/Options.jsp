               ...
               <webuijsf:form id="form1">
                  ...
                  <webuijsf:staticText binding="#{Options.responseText}" 
                     ...
                     style="font-size: 18px; left: 24px; top: 24px;
                        position: absolute"/>
                  <webuijsf:staticText 
                     binding="#{Options.selectionsText}" 
                     id="selectionsText" rendered="false"
                     style="left: 24px; top: 72px; position: absolute" 
                     text="Number of selections so far:"/>
                  <webuijsf:staticText 
                     binding="#{Options.selectionsValueText}" 
                     id="selectionsValueText" rendered="false"
                     style="left: 168px; top: 72px; position: absolute" 
                     text="#{SessionBean1.numberOfSelections}"/>
                  <webuijsf:hyperlink 
                     actionExpression="#{Options.languagesLink_action}" 
                     binding="#{Options.languagesLink}" id="languagesLink"
                     rendered="false" style="left: 24px; top: 96px; 
                        position: absolute" 
