// Fig. 29.30: Recommendations.java
// Displays book recommendations based on a HashMap property in the  
// session bean that contains the user's selected programming languages.
package sessions;
...
public class Recommendations extends AbstractPageBean
{
   ...
   public void prerender()
   {
      ...
      int numberSelected = getSessionBean1().getNumberOfSelections();         
         
      // if there are selections, store the corresponding 
